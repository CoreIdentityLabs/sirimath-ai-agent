...
export const UserProfileSchema = z.object({
  ...
  locale: z.string().max(64).nullable().default(null),
  homeLocation: z.string().max(128).nullable().default(null),
  summary: z.string().max(1024).nullable().default(null),
  preferences: z.record(z.string(), z.unknown()).default({}),
  updatedAt: z.coerce.date(),
  profileBackfilledAt: z.coerce.date().nullable().default(null),
});
...
export const UserProfilePatchSchema = z.object({
  ...
  homeLocation: z.string().max(128).nullable().optional(),
  summary: z.string().max(1024).nullable().optional(),
  preferences: z.record(z.string(), z.unknown()).optional(),
  profileBackfilledAt: z.coerce.date().nullable().optional(),
});
...
export const ExtractedProfilePatchSchema = z.object({
  displayName: z.string().max(128).nullable().optional(),
  timezone: z.string().max(64).nullable().optional(),
  locale: z.string().max(64).nullable().optional(),
  homeLocation: z.string().max(128).nullable().optional(),
...
export type ExtractedProfilePatch = z.infer<typeof ExtractedProfilePatchSchema>;

export const ExtractionResultSchema = z.object({
  profilePatch: ExtractedProfilePatchSchema.default({}),
...
export const RetrievalBundleSchema = z.object({
  ...
  matchedItems: z.array(MemoryItemSchema),
  recentItems: z.array(MemoryItemSchema),
});
